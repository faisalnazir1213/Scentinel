...
class ScentinelApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Image Detection and Analysis")
        self.model = YOLO(r"E:\Google dRive\China\best.pt")  # Update path as needed
        self.image = None
        self.image1 = None
    ...
    def setup_gui(self):
        ...
        #self.btn_detect = ttk.Button(self.frame, text="Run Detection", command=self.run_detection, state=tk.DISABLED)
    ...
    def process_image(self):
        ...
        # self.enhanced_gray = self.gray_image.copy()
    ...
    def run_detection(self):
        results = self.model(self.image, conf=0.35, iou=0.01, agnostic_nms=True)
        ...
        for i, box in enumerate(results[0].boxes):
            ...
            cv2.circle(self.image1, (x_center, y_center), radius, (255, 255, 255), 8)
            ...
            new_data = pd.DataFrame({'Object': [i+1], 'Area': [area], 'Signal': [intensity_sum]})
